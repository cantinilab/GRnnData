...
- 🎯 Entry points to execute your program using `python -m <grnndata>` or `$ grnndata` with basic CLI argument parsing.
...
Awesome grnndata created by cantinilab
...
```py
from grnndata import BaseClass
from grnndata import base_function
